...
public class Tread_test6 {
	...
	public static void main(String[] args) throws Exception, ExecutionException {
		...
		t10.start();
		int total=(int)ft1.get()+(int)ft2.get()+(int)ft3.get()+(int)ft4.get()+(int)ft5.get()
			+(int)ft6.get()+(int)ft7.get()+(int)ft8.get()+(int)ft9.get()+(int)ft10.get();
		System.out.println("线程1到线程2的求和的结果是"+total);
	}
